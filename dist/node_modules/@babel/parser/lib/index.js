...
var StandardErrors = {
  ...
  InvalidOrUnexpectedToken: function InvalidOrUnexpectedToken(_ref17) {
    var unexpected = _ref17.unexpected;
    return "Unexpected character '".concat(unexpected, "'.");
  },
  InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.",
  InvalidPrivateFieldResolution: function InvalidPrivateFieldResolution(_ref18) {
  ...
  LabelRedeclaration: function LabelRedeclaration(_ref19) {
  ...
  MissingPlugin: function MissingPlugin(_ref20) {
  ...
  MissingOneOfPlugins: function MissingOneOfPlugins(_ref21) {
  ...
  ModuleAttributesWithDuplicateKeys: function ModuleAttributesWithDuplicateKeys(_ref22) {
    var key = _ref22.key;
    return "Duplicate key \"".concat(key, "\" is not allowed in module attributes.");
  },
  ModuleExportNameHasLoneSurrogate: function ModuleExportNameHasLoneSurrogate(_ref23) {
  ...
  ModuleExportUndefined: function ModuleExportUndefined(_ref24) {
  ...
  PrivateInExpectedIn: function PrivateInExpectedIn(_ref25) {
  ...
  PrivateNameRedeclaration: function PrivateNameRedeclaration(_ref26) {
  ...
  UnexpectedKeyword: function UnexpectedKeyword(_ref27) {
  ...
  UnexpectedReservedWord: function UnexpectedReservedWord(_ref28) {
    var reservedWord = _ref28.reservedWord;
    return "Unexpected reserved word '".concat(reservedWord, "'.");
  },
  UnexpectedSuper: "'super' is only allowed in object methods and classes.",
  UnexpectedToken: function UnexpectedToken(_ref29) {
    var expected = _ref29.expected,
      unexpected = _ref29.unexpected;
  ...
  UnsupportedMetaProperty: function UnsupportedMetaProperty(_ref30) {
    var target = _ref30.target,
      onlyValidPropertyName = _ref30.onlyValidPropertyName;
  ...
  VarRedeclaration: function VarRedeclaration(_ref31) {
...
var StrictModeErrors = {
  ...
  StrictEvalArguments: function StrictEvalArguments(_ref32) {
    var referenceName = _ref32.referenceName;
    return "Assigning to '".concat(referenceName, "' in strict mode.");
  },
  StrictEvalArgumentsBinding: function StrictEvalArgumentsBinding(_ref33) {
...
var PipelineOperatorErrors = Object.assign({
  ...
  PipeTopicUnconfiguredToken: function PipeTopicUnconfiguredToken(_ref34) {
  ...
  PipeUnparenthesizedBody: function PipeUnparenthesizedBody(_ref35) {
...
function toParseErrorConstructor(_ref36) {
  var toMessage = _ref36.toMessage,
    code = _ref36.code,
    reasonCode = _ref36.reasonCode,
    syntaxPlugin = _ref36.syntaxPlugin;
  ...
  return /*#__PURE__*/function (_superClass) {
    ...
    return _createClass(ESTreeParserMixin, [{
      ...
      value: function parse() {
        var file = toESTreeLocation(_superPropGet(ESTreeParserMixin, "parse", this, 3)([]));
      ...
      value: function initFunction(node, isAsync) {
        _superPropGet(ESTreeParserMixin, "initFunction", this, 3)([node, isAsync]);
      ...
      value: function checkDeclaration(node) {
        if (node != null && this.isObjectProperty(node)) {
          ...
          _superPropGet(ESTreeParserMixin, "checkDeclaration", this, 3)([node]);
        }
      }
    }, {
      ...
      value: function parseBlockBody(node, allowDirectives, topLevel, end, afterBlockParse) {
        var _this2 = this;
        _superPropGet(ESTreeParserMixin, "parseBlockBody", this, 3)([node, allowDirectives, topLevel, end, afterBlockParse]);
      ...
      value: function parsePrivateName() {
        var node = _superPropGet(ESTreeParserMixin, "parsePrivateName", this, 3)([]);
        {
      ...
      value: function convertPrivateNameToPrivateIdentifier(node) {
        var name = _superPropGet(ESTreeParserMixin, "getPrivateNameSV", this, 3)([node]);
        node = node;
        delete node.id;
        node.name = name;
      ...
      value: function isPrivateName(node) {
        {
          if (!this.getPluginOption("estree", "classFeatures")) {
            return _superPropGet(ESTreeParserMixin, "isPrivateName", this, 3)([node]);
          }
        }
      ...
      value: function getPrivateNameSV(node) {
        {
          if (!this.getPluginOption("estree", "classFeatures")) {
            return _superPropGet(ESTreeParserMixin, "getPrivateNameSV", this, 3)([node]);
          }
        }
        return node.name;
      }
      ...
      value: function parseLiteral(value, type) {
        var node = _superPropGet(ESTreeParserMixin, "parseLiteral", this, 3)([value, type]);
      ...
      value: function parseFunctionBody(node, allowExpression) {
        ...
        _superPropGet(ESTreeParserMixin, "parseFunctionBody", this, 3)([node, allowExpression, isMethod]);
      ...
      value: function parseMethod(node, isGenerator, isAsync, isConstructor, allowDirectSuper, type) {
        ...
        funcNode = _superPropGet(ESTreeParserMixin, "parseMethod", this, 3)([funcNode, isGenerator, isAsync, isConstructor, allowDirectSuper, type, inClassScope]);
      ...
      value: function nameIsConstructor(key) {
        ...
        return _superPropGet(ESTreeParserMixin, "nameIsConstructor", this, 3)([key]);
      }
    }, {
      ...
      value: function parseClassProperty() {
        ...
        var propertyNode = _superPropGet(ESTreeParserMixin, "parseClassProperty", this, 3)(args);
        {
          if (!this.getPluginOption("estree", "classFeatures")) {
            return propertyNode;
          }
      ...
      value: function parseClassPrivateProperty() {
        ...
        var propertyNode = _superPropGet(ESTreeParserMixin, "parseClassPrivateProperty", this, 3)(args);
        {
          if (!this.getPluginOption("estree", "classFeatures")) {
            return propertyNode;
          }
      ...
      value: function parseClassAccessorProperty(node) {
        var accessorPropertyNode = _superPropGet(ESTreeParserMixin, "parseClassAccessorProperty", this, 3)([node]);
        {
          if (!this.getPluginOption("estree", "classFeatures")) {
      ...
      value: function parseObjectMethod(prop, isGenerator, isAsync, isPattern, isAccessor) {
        var node = _superPropGet(ESTreeParserMixin, "parseObjectMethod", this, 3)([prop, isGenerator, isAsync, isPattern, isAccessor]);
        if (node) {
          node.type = "Property";
          if (node.kind === "method") {
            node.kind = "init";
      ...
      value: function parseObjectProperty(prop, startLoc, isPattern, refExpressionErrors) {
        var node = _superPropGet(ESTreeParserMixin, "parseObjectProperty", this, 3)([prop, startLoc, isPattern, refExpressionErrors]);
        if (node) {
          node.kind = "init";
          node.type = "Property";
        }
      ...
      value: function isValidLVal(type, isUnparenthesizedInAssign, binding) {
        return type === "Property" ? "value" : _superPropGet(ESTreeParserMixin, "isValidLVal", this, 3)([type, isUnparenthesizedInAssign, binding]);
      }
    }, {
      key: "isAssignable",
      value: function isAssignable(node, isBinding) {
        ...
        return _superPropGet(ESTreeParserMixin, "isAssignable", this, 3)([node, isBinding]);
      }
    }, {
      key: "toAssignable",
      value: function toAssignable(node) {
        ...
        if (node != null && this.isObjectProperty(node)) {
          ...
          _superPropGet(ESTreeParserMixin, "toAssignable", this, 3)([node, isLHS]);
        }
      }
    }, {
      ...
      value: function toAssignableObjectExpressionProp(prop, isLast, isLHS) {
        if (prop.type === "Property" && (prop.kind === "get" || prop.kind === "set")) {
          ...
          _superPropGet(ESTreeParserMixin, "toAssignableObjectExpressionProp", this, 3)([prop, isLast, isLHS]);
        }
      }
    }, {
      key: "finishCallExpression",
      value: function finishCallExpression(unfinished, optional) {
        var node = _superPropGet(ESTreeParserMixin, "finishCallExpression", this, 3)([unfinished, optional]);
      ...
      value: function toReferencedArguments(node) {
        ...
        _superPropGet(ESTreeParserMixin, "toReferencedArguments", this, 3)([node]);
      }
    }, {
      key: "parseExport",
      value: function parseExport(unfinished, decorators) {
        var exportStartLoc = this.state.lastTokStartLoc;
        var node = _superPropGet(ESTreeParserMixin, "parseExport", this, 3)([unfinished, decorators]);
        switch (node.type) {
      ...
      value: function parseSubscript(base, startLoc, noCalls, state) {
        var node = _superPropGet(ESTreeParserMixin, "parseSubscript", this, 3)([base, startLoc, noCalls, state]);
      ...
      value: function isOptionalMemberExpression(node) {
        ...
        return _superPropGet(ESTreeParserMixin, "isOptionalMemberExpression", this, 3)([node]);
      }
    }, {
      ...
      value: function hasPropertyAsPrivateName(node) {
        ...
        return _superPropGet(ESTreeParserMixin, "hasPropertyAsPrivateName", this, 3)([node]);
      }
    }, {
      ...
      value: function finishNodeAt(node, type, endLoc) {
        return toESTreeLocation(_superPropGet(ESTreeParserMixin, "finishNodeAt", this, 3)([node, type, endLoc]));
      }
    }, {
      key: "resetStartLocation",
      value: function resetStartLocation(node, startLoc) {
        _superPropGet(ESTreeParserMixin, "resetStartLocation", this, 3)([node, startLoc]);
      ...
      value: function resetEndLocation(node) {
        ...
        _superPropGet(ESTreeParserMixin, "resetEndLocation", this, 3)([node, endLoc]);
        toESTreeLocation(node);
      }
    }]);
  }(superClass);
...
var FlowScopeHandler = /*#__PURE__*/function (_ScopeHandler) {
  ...
  return _createClass(FlowScopeHandler, [{
    ...
    value: function declareName(name, bindingType, loc) {
      ...
      _superPropGet(FlowScopeHandler, "declareName", this, 3)([name, bindingType, loc]);
    }
  }, {
    key: "isRedeclaredInScope",
    value: function isRedeclaredInScope(scope, name, bindingType) {
      if (_superPropGet(FlowScopeHandler, "isRedeclaredInScope", this, 3)([scope, name, bindingType])) return true;
    ...
    value: function checkLocalExport(id) {
      if (!this.scopeStack[0].declareFunctions.has(id.name)) {
        _superPropGet(FlowScopeHandler, "checkLocalExport", this, 3)([id]);
      }
    }
  }]);
}(ScopeHandler);
  ...
  return _createClass(BaseParser, [{
    ...
    value: function hasPlugin(pluginConfig) {
      if (typeof pluginConfig === "string") {
        ...
        for (var _i3 = 0, _Object$keys3 = Object.keys(pluginOptions); _i3 < _Object$keys3.length; _i3++) {
...
var Tokenizer = /*#__PURE__*/function (_CommentsParser) {
  function Tokenizer(options, input) {
    ...
    _this4.errorHandlers_readInt = {
      invalidDigit: function invalidDigit(pos, lineStart, curLine, radix) {
        if (!(_this4.optionFlags & 2048)) return false;
  ...
  return _createClass(Tokenizer, [{
    ...
    value: function skipSpace() {
      ...
      var comments = this.optionFlags & 4096 ? [] : null;
  ...
  return /*#__PURE__*/function (_superClass2) {
    ...
    return _createClass(FlowParserMixin, [{
      ...
      value: function finishToken(type, val) {
        ...
        _superPropGet(FlowParserMixin, "finishToken", this, 3)([type, val]);
      }
    }, {
      key: "addComment",
      value: function addComment(comment) {
        ...
        _superPropGet(FlowParserMixin, "addComment", this, 3)([comment]);
      }
    }, {
      ...
      value: function flowParsePredicate() {
        ...
        if (this.eat(10)) {
          node.value = _superPropGet(FlowParserMixin, "parseExpression", this, 3)([]);
          this.expect(11);
      ...
      value: function flowParseDeclareModule(node) {
        ...
        this.scope.enter(0);
        if (this.match(134)) {
          node.id = _superPropGet(FlowParserMixin, "parseExprAtom", this, 3)([]);
        } else {
        ...
        while (!this.match(8)) {
          ...
          if (this.match(83)) {
            ...
            _superPropGet(FlowParserMixin, "parseImport", this, 3)([_bodyNode]);
          } else {
      ...
      value: function flowParseTypeParameterInstantiation() {
        ...
        this.flowInTopLevelContext(function () {
          _this13.expect(47);
          var oldNoAnonFunctionType = _this13.state.noAnonFunctionType;
          _this13.state.noAnonFunctionType = false;
          while (!_this13.match(48)) {
            node.params.push(_this13.flowParseType());
            if (!_this13.match(48)) {
              _this13.expect(12);
            }
          }
          _this13.state.noAnonFunctionType = oldNoAnonFunctionType;
        });
        this.state.inType = oldInType;
      ...
      value: function flowParseObjectPropertyKey() {
        return this.match(135) || this.match(134) ? _superPropGet(FlowParserMixin, "parseExprAtom", this, 3)([]) : this.parseIdentifier(true);
      }
    }, {
        ...
        switch (this.state.type) {
          ...
          default:
            if (tokenIsKeyword(this.state.type)) {
              ...
              this.next();
              return _superPropGet(FlowParserMixin, "createIdentifier", this, 3)([node, label]);
      ...
      value: function parseFunctionBody(node, allowExpressionBody) {
        ...
        if (allowExpressionBody) {
          this.forwardNoArrowParamsConversionAt(node, function () {
            return _superPropGet(FlowParserMixin, "parseFunctionBody", _this14, 3)([node, true, isMethod]);
          });
          return;
        }
        _superPropGet(FlowParserMixin, "parseFunctionBody", this, 3)([node, false, isMethod]);
      }
    }, {
      ...
      value: function parseFunctionBodyAndFinish(node, type) {
        ...
        return _superPropGet(FlowParserMixin, "parseFunctionBodyAndFinish", this, 3)([node, type, isMethod]);
      }
    }, {
      ...
      value: function parseStatementLike(flags) {
        ...
        var stmt = _superPropGet(FlowParserMixin, "parseStatementLike", this, 3)([flags]);
      ...
      value: function parseExpressionStatement(node, expr, decorators) {
        ...
        return _superPropGet(FlowParserMixin, "parseExpressionStatement", this, 3)([node, expr, decorators]);
      }
    }, {
      ...
      value: function shouldParseExportDeclaration() {
        ...
        return _superPropGet(FlowParserMixin, "shouldParseExportDeclaration", this, 3)([]);
      }
    }, {
      ...
      value: function isExportDefaultSpecifier() {
        ...
        return _superPropGet(FlowParserMixin, "isExportDefaultSpecifier", this, 3)([]);
      }
    }, {
      ...
      value: function parseExportDefaultExpression() {
        ...
        return _superPropGet(FlowParserMixin, "parseExportDefaultExpression", this, 3)([]);
      }
    }, {
      ...
      value: function parseConditional(expr, startLoc, refExpressionErrors) {
        ...
        node.alternate = this.forwardNoArrowParamsConversionAt(node, function () {
          return _this15.parseMaybeAssign(undefined, undefined);
        });
      ...
      value: function getArrowLikeExpressions(node, disallowInvalid) {
        ...
        if (disallowInvalid) {
          arrows.forEach(function (node) {
            return _this16.finishArrowValidation(node);
          });
          return [arrows, []];
        }
        return partition(arrows, function (node) {
          return node.params.every(function (param) {
            return _this16.isAssignable(param, true);
          });
        });
      }
    }, {
      ...
      value: function finishArrowValidation(node) {
        ...
        _superPropGet(FlowParserMixin, "checkParams", this, 3)([node, false, true]);
        this.scope.exit();
      }
    }, {
      ...
      value: function parseParenItem(node, startLoc) {
        var newNode = _superPropGet(FlowParserMixin, "parseParenItem", this, 3)([node, startLoc]);
        if (this.eat(17)) {
      ...
      value: function assertModuleNodeAllowed(node) {
        ...
        _superPropGet(FlowParserMixin, "assertModuleNodeAllowed", this, 3)([node]);
      }
    }, {
      ...
      value: function parseExportDeclaration(node) {
        if (this.isContextual(130)) {
          ...
          if (this.match(5)) {
            ...
            _superPropGet(FlowParserMixin, "parseExportFrom", this, 3)([node]);
            return null;
          } else {
          ...
          return _superPropGet(FlowParserMixin, "parseExportDeclaration", this, 3)([node]);
        }
      }
    }, {
      key: "eatExportStar",
      value: function eatExportStar(node) {
        if (_superPropGet(FlowParserMixin, "eatExportStar", this, 3)([node])) return true;
      ...
      value: function maybeParseExportNamespaceSpecifier(node) {
        var startLoc = this.state.startLoc;
        var hasNamespace = _superPropGet(FlowParserMixin, "maybeParseExportNamespaceSpecifier", this, 3)([node]);
      ...
      value: function parseClassId(node, isStatement, optionalId) {
        _superPropGet(FlowParserMixin, "parseClassId", this, 3)([node, isStatement, optionalId]);
        if (this.match(47)) {
          node.typeParameters = this.flowParseTypeParameterDeclaration();
        }
      }
      ...
      value: function parseClassMember(classBody, member, state) {
        ...
        if (this.isContextual(125)) {
          if (_superPropGet(FlowParserMixin, "parseClassMemberFromModifier", this, 3)([classBody, member])) {
            return;
          }
          member.declare = true;
        }
        _superPropGet(FlowParserMixin, "parseClassMember", this, 3)([classBody, member, state]);
        if (member.declare) {
      ...
      value: function readIterator() {
        var word = _superPropGet(FlowParserMixin, "readWord1", this, 3)([]);
        var fullWord = "@@" + word;
      ...
      value: function getTokenFromCode(code) {
        ...
        if (code === 123 && next === 124) {
          ...
          _superPropGet(FlowParserMixin, "getTokenFromCode", this, 3)([code]);
        }
      }
    }, {
      key: "isAssignable",
      value: function isAssignable(node, isBinding) {
        if (node.type === "TypeCastExpression") {
          ...
          return _superPropGet(FlowParserMixin, "isAssignable", this, 3)([node, isBinding]);
        }
      }
    }, {
      key: "toAssignable",
      value: function toAssignable(node) {
        ...
        _superPropGet(FlowParserMixin, "toAssignable", this, 3)([node, isLHS]);
      }
    }, {
      ...
      value: function toAssignableList(exprList, trailingCommaLoc, isLHS) {
        ...
        _superPropGet(FlowParserMixin, "toAssignableList", this, 3)([exprList, trailingCommaLoc, isLHS]);
      }
    }, {
      ...
      value: function parseArrayLike(close, canBePattern, isTuple, refExpressionErrors) {
        var node = _superPropGet(FlowParserMixin, "parseArrayLike", this, 3)([close, canBePattern, isTuple, refExpressionErrors]);
      ...
      value: function parseClassProperty(node) {
        ...
        return _superPropGet(FlowParserMixin, "parseClassProperty", this, 3)([node]);
      }
    }, {
      key: "parseClassPrivateProperty",
      value: function parseClassPrivateProperty(node) {
        ...
        return _superPropGet(FlowParserMixin, "parseClassPrivateProperty", this, 3)([node]);
      }
    }, {
      key: "isClassMethod",
      value: function isClassMethod() {
        return this.match(47) || _superPropGet(FlowParserMixin, "isClassMethod", this, 3)([]);
      }
    }, {
      key: "isClassProperty",
      value: function isClassProperty() {
        return this.match(14) || _superPropGet(FlowParserMixin, "isClassProperty", this, 3)([]);
      }
    }, {
      key: "isNonstaticConstructor",
      value: function isNonstaticConstructor(method) {
        return !this.match(14) && _superPropGet(FlowParserMixin, "isNonstaticConstructor", this, 3)([method]);
      }
    }, {
      key: "pushClassMethod",
      value: function pushClassMethod(classBody, method, isGenerator, isAsync, isConstructor, allowsDirectSuper) {
        ...
        _superPropGet(FlowParserMixin, "pushClassMethod", this, 3)([classBody, method, isGenerator, isAsync, isConstructor, allowsDirectSuper]);
      ...
      value: function pushClassPrivateMethod(classBody, method, isGenerator, isAsync) {
        ...
        _superPropGet(FlowParserMixin, "pushClassPrivateMethod", this, 3)([classBody, method, isGenerator, isAsync]);
      }
    }, {
      key: "parseClassSuper",
      value: function parseClassSuper(node) {
        _superPropGet(FlowParserMixin, "parseClassSuper", this, 3)([node]);
      ...
      value: function checkGetterSetterParams(method) {
        _superPropGet(FlowParserMixin, "checkGetterSetterParams", this, 3)([method]);
      ...
      value: function parseObjPropValue(prop, startLoc, isGenerator, isAsync, isPattern, isAccessor, refExpressionErrors) {
        ...
        var result = _superPropGet(FlowParserMixin, "parseObjPropValue", this, 3)([prop, startLoc, isGenerator, isAsync, isPattern, isAccessor, refExpressionErrors]);
        if (typeParameters) {
      ...
      value: function parseMaybeDefault(startLoc, left) {
        var node = _superPropGet(FlowParserMixin, "parseMaybeDefault", this, 3)([startLoc, left]);
      ...
      value: function checkImportReflection(node) {
        _superPropGet(FlowParserMixin, "checkImportReflection", this, 3)([node]);
      ...
      value: function isPotentialImportPhase(isExport) {
        if (_superPropGet(FlowParserMixin, "isPotentialImportPhase", this, 3)([isExport])) return true;
        if (this.isContextual(130)) {
      ...
      value: function applyImportPhase(node, isExport, phase, loc) {
        _superPropGet(FlowParserMixin, "applyImportPhase", this, 3)([node, isExport, phase, loc]);
        if (isExport) {
      ...
      value: function parseBindingAtom() {
        switch (this.state.type) {
          ...
          default:
            return _superPropGet(FlowParserMixin, "parseBindingAtom", this, 3)([]);
        }
      }
    }, {
      ...
      value: function parseFunctionParams(node, isConstructor) {
        ...
        _superPropGet(FlowParserMixin, "parseFunctionParams", this, 3)([node, isConstructor]);
      }
    }, {
      key: "parseVarId",
      value: function parseVarId(decl, kind) {
        _superPropGet(FlowParserMixin, "parseVarId", this, 3)([decl, kind]);
        if (this.match(14)) {
      ...
      value: function parseAsyncArrowFromCallExpression(node, call) {
        ...
        return _superPropGet(FlowParserMixin, "parseAsyncArrowFromCallExpression", this, 3)([node, call]);
      }
    }, {
      key: "shouldParseAsyncArrow",
      value: function shouldParseAsyncArrow() {
        return this.match(14) || _superPropGet(FlowParserMixin, "shouldParseAsyncArrow", this, 3)([]);
      }
    }, {
      ...
      value: function parseMaybeAssign(refExpressionErrors, afterLeftParse) {
        ...
        if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
          ...
          jsx = this.tryParse(function () {
            return _superPropGet(FlowParserMixin, "parseMaybeAssign", _this17, 3)([refExpressionErrors, afterLeftParse]);
          }, state);
        ...
        if ((_jsx = jsx) != null && _jsx.error || this.match(47)) {
          ...
          var arrow = this.tryParse(function (abort) {
            ...
            typeParameters = _this17.flowParseTypeParameterDeclaration();
            var arrowExpression = _this17.forwardNoArrowParamsConversionAt(typeParameters, function () {
              var result = _superPropGet(FlowParserMixin, "parseMaybeAssign", _this17, 3)([refExpressionErrors, afterLeftParse]);
              _this17.resetStartLocationFromNode(result, typeParameters);
              return result;
            });
            if ((_arrowExpression$extr = arrowExpression.extra) != null && _arrowExpression$extr.parenthesized) abort();
            var expr = _this17.maybeUnwrapTypeCastExpression(arrowExpression);
            if (expr.type !== "ArrowFunctionExpression") abort();
            expr.typeParameters = typeParameters;
            _this17.resetStartLocationFromNode(expr, typeParameters);
        ...
        return _superPropGet(FlowParserMixin, "parseMaybeAssign", this, 3)([refExpressionErrors, afterLeftParse]);
      }
    }, {
      key: "parseArrow",
      value: function parseArrow(node) {
        ...
        if (this.match(14)) {
          var result = this.tryParse(function () {
            var oldNoAnonFunctionType = _this18.state.noAnonFunctionType;
            _this18.state.noAnonFunctionType = true;
            var typeNode = _this18.startNode();
            var _this18$flowParseType = _this18.flowParseTypeAndPredicateInitialiser();
            var _this18$flowParseType2 = _slicedToArray(_this18$flowParseType, 2);
            typeNode.typeAnnotation = _this18$flowParseType2[0];
            node.predicate = _this18$flowParseType2[1];
            _this18.state.noAnonFunctionType = oldNoAnonFunctionType;
            if (_this18.canInsertSemicolon()) _this18.unexpected();
            if (!_this18.match(19)) _this18.unexpected();
            return typeNode;
          });
        ...
        return _superPropGet(FlowParserMixin, "parseArrow", this, 3)([node]);
      }
    }, {
      key: "shouldParseArrow",
      value: function shouldParseArrow(params) {
        return this.match(14) || _superPropGet(FlowParserMixin, "shouldParseArrow", this, 3)([params]);
      }
    }, {
      ...
      value: function setArrowFunctionParameters(node, params) {
        if (this.state.noArrowParamsConversionAt.includes(this.offsetToSourcePos(node.start))) {
          ...
          _superPropGet(FlowParserMixin, "setArrowFunctionParameters", this, 3)([node, params]);
        }
      }
    }, {
      key: "checkParams",
      value: function checkParams(node, allowDuplicates, isArrowFunction) {
        ...
        _superPropGet(FlowParserMixin, "checkParams", this, 3)([node, allowDuplicates, isArrowFunction, strictModeChanged]);
      }
    }, {
      key: "parseParenAndDistinguishExpression",
      value: function parseParenAndDistinguishExpression(canBeArrow) {
        return _superPropGet(FlowParserMixin, "parseParenAndDistinguishExpression", this, 3)([canBeArrow && !this.state.noArrowAt.includes(this.sourceToOffsetPos(this.state.start))]);
      }
    }, {
      key: "parseSubscripts",
      value: function parseSubscripts(base, startLoc, noCalls) {
        ...
        if (base.type === "Identifier" && base.name === "async" && this.state.noArrowAt.includes(startLoc.index)) {
          ...
          var node = this.startNodeAt(startLoc);
          node.callee = base;
          node.arguments = _superPropGet(FlowParserMixin, "parseCallExpressionArguments", this, 3)([11]);
          base = this.finishNode(node, "CallExpression");
        } else if (base.type === "Identifier" && base.name === "async" && this.match(47)) {
          var state = this.state.clone();
          var arrow = this.tryParse(function (abort) {
            return _this19.parseAsyncArrowWithTypeParameters(startLoc) || abort();
          }, state);
          if (!arrow.error && !arrow.aborted) return arrow.node;
          var result = this.tryParse(function () {
            return _superPropGet(FlowParserMixin, "parseSubscripts", _this19, 3)([base, startLoc, noCalls]);
          }, state);
        ...
        return _superPropGet(FlowParserMixin, "parseSubscripts", this, 3)([base, startLoc, noCalls]);
      }
    }, {
      key: "parseSubscript",
      value: function parseSubscript(base, startLoc, noCalls, subscriptState) {
        ...
        if (this.match(18) && this.isLookaheadToken_lt()) {
          ...
          _node6.callee = base;
          var result = this.tryParse(function () {
            _node6.typeArguments = _this20.flowParseTypeParameterInstantiationCallOrNew();
            _this20.expect(10);
            _node6.arguments = _superPropGet(FlowParserMixin, "parseCallExpressionArguments", _this20, 3)([11]);
            if (subscriptState.optionalChainMember) {
              _node6.optional = false;
            }
            return _this20.finishCallExpression(_node6, subscriptState.optionalChainMember);
          });
          if (result.node) {
            if (result.error) this.state = result.failState;
            return result.node;
        ...
        return _superPropGet(FlowParserMixin, "parseSubscript", this, 3)([base, startLoc, noCalls, subscriptState]);
      }
    }, {
      key: "parseNewCallee",
      value: function parseNewCallee(node) {
        var _this21 = this;
        _superPropGet(FlowParserMixin, "parseNewCallee", this, 3)([node]);
        var targs = null;
        if (this.shouldParseTypes() && this.match(47)) {
          targs = this.tryParse(function () {
            return _this21.flowParseTypeParameterInstantiationCallOrNew();
          }).node;
        }
      ...
      value: function parseAsyncArrowWithTypeParameters(startLoc) {
        ...
        return _superPropGet(FlowParserMixin, "parseArrowExpression", this, 3)([node, undefined, true]);
      }
    }, {
      key: "readToken_mult_modulo",
      value: function readToken_mult_modulo(code) {
        ...
        _superPropGet(FlowParserMixin, "readToken_mult_modulo", this, 3)([code]);
      }
    }, {
      key: "readToken_pipe_amp",
      value: function readToken_pipe_amp(code) {
        ...
        _superPropGet(FlowParserMixin, "readToken_pipe_amp", this, 3)([code]);
      }
    }, {
      key: "parseTopLevel",
      value: function parseTopLevel(file, program) {
        var fileNode = _superPropGet(FlowParserMixin, "parseTopLevel", this, 3)([file, program]);
      ...
      value: function skipBlockComment() {
        ...
        return _superPropGet(FlowParserMixin, "skipBlockComment", this, 3)([this.state.hasFlowComment ? "*-/" : "*/"]);
      }
    }, {
      key: "skipFlowComment",
      ...
      value: function flowEnumMemberInit() {
        ...
        var endOfInit = function endOfInit() {
          return _this22.match(12) || _this22.match(8);
        };
        switch (this.state.type) {
          case 135:
            {
          ...
          default:
            {
              var empty = function empty() {
                node.members = [];
                _this23.expect(8);
                return _this23.finishNode(node, "EnumStringBody");
              };
      ...
      value: function jsxParseOpeningElementAfterName(node) {
        ...
        return _superPropGet(FlowParserMixin, "jsxParseOpeningElementAfterName", this, 3)([node]);
      }
    }, {
    ...
    return _createClass(JSXParserMixin, [{
            ...
            case 123:
              if (this.state.pos === this.state.start) {
                if (ch === 60 && this.state.canStartJSXElement) {
                  ...
                  _superPropGet(JSXParserMixin, "getTokenFromCode", this, 3)([ch]);
                }
                return;
              }
      ...
      value: function parseExprAtom(refExpressionErrors) {
        if (this.match(143)) {
          ...
          return _superPropGet(JSXParserMixin, "parseExprAtom", this, 3)([refExpressionErrors]);
        }
      }
    }, {
      key: "skipSpace",
      value: function skipSpace() {
        ...
        if (!curContext.preserveSpace) _superPropGet(JSXParserMixin, "skipSpace", this, 3)([]);
      }
    }, {
      key: "getTokenFromCode",
      value: function getTokenFromCode(code) {
        ...
        _superPropGet(JSXParserMixin, "getTokenFromCode", this, 3)([code]);
      }
    }, {
      key: "updateContext",
      value: function updateContext(prevType) {
...
var TypeScriptScope = /*#__PURE__*/function (_Scope2) {
  function TypeScriptScope() {
    ...
    _this24 = _callSuper(this, TypeScriptScope, [].concat(args));
    _this24.tsNames = new Map();
    return _this24;
  }
...
var TypeScriptScopeHandler = /*#__PURE__*/function (_ScopeHandler2) {
  function TypeScriptScopeHandler() {
    ...
    _this25 = _callSuper(this, TypeScriptScopeHandler, [].concat(args));
    _this25.importsStack = [];
    return _this25;
  }
  ...
  return _createClass(TypeScriptScopeHandler, [{
    ...
    value: function enter(flags) {
      ...
      _superPropGet(TypeScriptScopeHandler, "enter", this, 3)([flags]);
    }
  }, {
    key: "exit",
    value: function exit() {
      var flags = _superPropGet(TypeScriptScopeHandler, "exit", this, 3)([]);
      if (flags === 256) {
    ...
    value: function declareName(name, bindingType, loc) {
      ...
      _superPropGet(TypeScriptScopeHandler, "declareName", this, 3)([name, bindingType, loc]);
      if (bindingType & 2) {
        if (!(bindingType & 1)) {
          this.checkRedeclarationInScope(scope, name, bindingType, loc);
          this.maybeExportDefined(scope, name);
    ...
    value: function isRedeclaredInScope(scope, name, bindingType) {
      ...
      return _superPropGet(TypeScriptScopeHandler, "isRedeclaredInScope", this, 3)([scope, name, bindingType]);
    }
  }, {
    key: "checkLocalExport",
    value: function checkLocalExport(id) {
      ...
      _superPropGet(TypeScriptScopeHandler, "checkLocalExport", this, 3)([id]);
    }
  }]);
}(ScopeHandler);
...
var LValParser = /*#__PURE__*/function (_NodeUtils) {
  ...
  return _createClass(LValParser, [{
    ...
    value: function toAssignableListItem(exprList, index, isLHS) {
      ...
      switch (node.type) {
        ...
        case "ObjectExpression":
          {
            ...
            return node.properties.every(function (prop, i) {
              return prop.type !== "ObjectMethod" && (i === last || prop.type !== "SpreadElement") && _this26.isAssignable(prop);
            });
          }
        case "ObjectProperty":
        ...
        case "ArrayExpression":
          return node.elements.every(function (element) {
            return element === null || _this26.isAssignable(element);
          });
        case "AssignmentExpression":
    ...
    value: function parseBindingElement(flags, decorators) {
...
var TSErrors = ParseErrorEnum(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["typescript"])))({
  AbstractMethodHasImplementation: function AbstractMethodHasImplementation(_ref65) {
    var methodName = _ref65.methodName;
    return "Method '".concat(methodName, "' cannot have an implementation because it is marked abstract.");
  },
  AbstractPropertyHasInitializer: function AbstractPropertyHasInitializer(_ref66) {
    var propertyName = _ref66.propertyName;
  ...
  DeclareAccessor: function DeclareAccessor(_ref67) {
    var kind = _ref67.kind;
    return "'declare' is not allowed in ".concat(kind, "ters.");
  },
  DeclareClassFieldHasInitializer: "Initializers are not allowed in ambient contexts.",
  DeclareFunctionHasImplementation: "An implementation cannot be declared in ambient contexts.",
  DuplicateAccessibilityModifier: function DuplicateAccessibilityModifier(_ref68) {
    var modifier = _ref68.modifier;
    return "Accessibility modifier already seen.";
  },
  DuplicateModifier: function DuplicateModifier(_ref69) {
    var modifier = _ref69.modifier;
    return "Duplicate modifier: '".concat(modifier, "'.");
  },
  EmptyHeritageClauseType: function EmptyHeritageClauseType(_ref70) {
  ...
  IncompatibleModifiers: function IncompatibleModifiers(_ref71) {
    var modifiers = _ref71.modifiers;
    return "'".concat(modifiers[0], "' modifier cannot be used with '").concat(modifiers[1], "' modifier.");
  },
  IndexSignatureHasAbstract: "Index signatures cannot have the 'abstract' modifier.",
  IndexSignatureHasAccessibility: function IndexSignatureHasAccessibility(_ref72) {
  ...
  InvalidHeritageClauseType: function InvalidHeritageClauseType(_ref73) {
    var token = _ref73.token;
    return "'".concat(token, "' list can only include identifiers or qualified-names with optional type arguments.");
  },
...
var typescript = function typescript(superClass) {
  return /*#__PURE__*/function (_superClass4) {
    function TypeScriptParserMixin() {
      ...
      _this27 = _callSuper(this, TypeScriptParserMixin, [].concat(args));
      _this27.tsParseInOutModifiers = _this27.tsParseModifiers.bind(_this27, {
        allowedModifiers: ["in", "out"],
        disallowedModifiers: ["const", "public", "private", "protected", "readonly", "declare", "abstract", "override"],
        errorTemplate: TSErrors.InvalidModifierOnTypeParameter
      });
      _this27.tsParseConstModifier = _this27.tsParseModifiers.bind(_this27, {
        allowedModifiers: ["const"],
        disallowedModifiers: ["in", "out"],
        errorTemplate: TSErrors.InvalidModifierOnTypeParameterPositions
      });
      _this27.tsParseInOutConstModifiers = _this27.tsParseModifiers.bind(_this27, {
    ...
    return _createClass(TypeScriptParserMixin, [{
      ...
      value: function tsParseModifiers(_ref81, modified) {
        ...
        var enforceOrder = function enforceOrder(loc, modifier, before, after) {
          if (modifier === before && modified[after]) {
            _this28.raise(TSErrors.InvalidModifiersOrder, loc, {
        ...
        var incompatible = function incompatible(loc, modifier, mod1, mod2) {
          if (modified[mod1] && modifier === mod2 || modified[mod2] && modifier === mod1) {
            _this28.raise(TSErrors.IncompatibleModifiers, loc, {
              modifiers: [mod1, mod2]
            });
          }
        };
      ...
      value: function tsParseImportType() {
        ...
        if (!this.match(134)) {
          ...
          {
            node.argument = _superPropGet(TypeScriptParserMixin, "parseExprAtom", this, 3)([]);
          }
        } else {
          {
        ...
        if (this.eat(12) && !this.match(11)) {
          node.options = _superPropGet(TypeScriptParserMixin, "parseMaybeAssignAllowIn", this, 3)([]);
          this.eat(12);
        } else {
          node.options = null;
        }
      ...
      value: function tsParseEntityName(flags) {
        ...
        while (this.eat(16)) {
          var _node8 = this.startNodeAtNode(entity);
          _node8.left = entity;
          _node8.right = this.parseIdentifier(!!(flags & 1));
          entity = this.finishNode(_node8, "TSQualifiedName");
        }
        return entity;
      }
    }, {
      ...
      value: function tsParseBindingListForSignature() {
        var list = _superPropGet(TypeScriptParserMixin, "parseBindingList", this, 3)([11, 41, 2]);
      ...
      value: function tsParseTypeMember() {
        ...
        _superPropGet(TypeScriptParserMixin, "parsePropertyName", this, 3)([node]);
      ...
      value: function tsParseTupleType() {
        ...
        node.elementTypes.forEach(function (elementNode) {
          ...
          if (seenOptionalElement && type !== "TSRestType" && type !== "TSOptionalType" && !(type === "TSNamedTupleMember" && elementNode.optional)) {
            _this29.raise(TSErrors.OptionalTypeBeforeRequired, elementNode);
          }
      ...
      value: function tsParseLiteralTypeNode() {
        ...
        switch (this.state.type) {
          ...
          case 85:
          case 86:
            node.literal = _superPropGet(TypeScriptParserMixin, "parseExprAtom", this, 3)([]);
            break;
          default:
            this.unexpected();
        }
      ...
      value: function tsParseTemplateLiteralType() {
        {
          var node = this.startNode();
          node.literal = _superPropGet(TypeScriptParserMixin, "parseTemplate", this, 3)([false]);
          return this.finishNode(node, "TSLiteralType");
        }
      }
    }, {
      ...
      value: function parseTemplateSubstitution() {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseTemplateSubstitution", this, 3)([]);
      }
    }, {
          ...
          default:
            {
              ...
              if (tokenIsIdentifier(type) || type === 88 || type === 84) {
                ...
                if (nodeType !== undefined && this.lookaheadCharCode() !== 46) {
                  ...
                  this.next();
                  return this.finishNode(_node9, nodeType);
                }
      ...
      value: function tsParseArrayTypeOrHigher() {
        ...
        while (!this.hasPrecedingLineBreak() && this.eat(0)) {
          if (this.match(3)) {
            ...
            _node10.objectType = type;
            _node10.indexType = this.tsParseType();
            this.expect(3);
            type = this.finishNode(_node10, "TSIndexedAccessType");
          }
        }
        return type;
      }
      ...
      value: function tsSkipParameterStart() {
        ...
        if (this.match(0)) {
          ...
          try {
            _superPropGet(TypeScriptParserMixin, "parseBindingList", this, 3)([3, 93, 1]);
      ...
      value: function tsParseTypeOrTypePredicateAnnotation(returnToken) {
        ...
        return this.tsInType(function () {
          var t = _this34.startNode();
          _this34.expect(returnToken);
          var node = _this34.startNode();
          var asserts = !!_this34.tsTryParse(_this34.tsParseTypePredicateAsserts.bind(_this34));
          if (asserts && _this34.match(78)) {
            var thisTypePredicate = _this34.tsParseThisTypeOrThisTypePredicate();
            if (thisTypePredicate.type === "TSThisType") {
              node.parameterName = thisTypePredicate;
              node.asserts = true;
              node.typeAnnotation = null;
              thisTypePredicate = _this34.finishNode(node, "TSTypePredicate");
            } else {
              _this34.resetStartLocationFromNode(thisTypePredicate, node);
              thisTypePredicate.asserts = true;
            }
            t.typeAnnotation = thisTypePredicate;
            return _this34.finishNode(t, "TSTypeAnnotation");
          }
          var typePredicateVariable = _this34.tsIsIdentifier() && _this34.tsTryParse(_this34.tsParseTypePredicatePrefix.bind(_this34));
          if (!typePredicateVariable) {
            if (!asserts) {
              return _this34.tsParseTypeAnnotation(false, t);
            }
            node.parameterName = _this34.parseIdentifier();
            node.asserts = asserts;
            node.typeAnnotation = null;
            t.typeAnnotation = _this34.finishNode(node, "TSTypePredicate");
            return _this34.finishNode(t, "TSTypeAnnotation");
          }
          var type = _this34.tsParseTypeAnnotation(false);
      ...
      value: function tsParseTypeAnnotation() {
        ...
        this.tsInType(function () {
          if (eatColon) _this35.expect(14);
          t.typeAnnotation = _this35.tsParseType();
        });
      ...
      value: function tsParseTypeAssertion() {
        ...
        node.typeAnnotation = this.tsInType(function () {
          _this37.next();
          return _this37.match(75) ? _this37.tsParseTypeReference() : _this37.tsParseType();
        });
        this.expect(48);
      ...
      value: function tsParseHeritageClause(token) {
        ...
        var delimitedList = this.tsParseDelimitedList("HeritageClauseElement", function () {
          {
            var node = _this38.startNode();
            node.expression = _this38.tsParseEntityName(1 | 2);
            if (_this38.match(47)) {
              node.typeParameters = _this38.tsParseTypeArguments();
            }
            return _this38.finishNode(node, "TSExpressionWithTypeArguments");
          }
        });
      ...
      value: function tsParseTypeAliasDeclaration(node) {
        ...
        node.typeAnnotation = this.tsInType(function () {
          node.typeParameters = _this39.tsTryParseTypeParameters(_this39.tsParseInOutModifiers);
          _this39.expect(29);
          if (_this39.isContextual(114) && _this39.lookahead().type !== 16) {
            var _node11 = _this39.startNode();
            _this39.next();
            return _this39.finishNode(_node11, "TSIntrinsicKeyword");
          }
      ...
      value: function tsParseEnumMember() {
        var node = this.startNode();
        node.id = this.match(134) ? _superPropGet(TypeScriptParserMixin, "parseStringLiteral", this, 3)([this.state.value]) : this.parseIdentifier(true);
        if (this.eat(29)) {
          node.initializer = _superPropGet(TypeScriptParserMixin, "parseMaybeAssignAllowIn", this, 3)([]);
        }
      ...
      value: function tsParseModuleBlock() {
        ...
        this.scope.enter(0);
        this.expect(5);
        _superPropGet(TypeScriptParserMixin, "parseBlockOrModuleBlockBody", this, 3)([node.body = [], undefined, true, 8]);
        this.scope.exit();
      ...
      value: function tsParseAmbientExternalModuleDeclaration(node) {
        if (this.isContextual(112)) {
          ...
          node.kind = "module";
          node.id = _superPropGet(TypeScriptParserMixin, "parseStringLiteral", this, 3)([this.state.value]);
        } else {
          this.unexpected();
        }
        if (this.match(5)) {
      ...
      value: function tsParseExternalModuleReference() {
        ...
        node.expression = _superPropGet(TypeScriptParserMixin, "parseExprAtom", this, 3)([]);
        this.expect(11);
      ...
      value: function tsTryParseDeclare(nany) {
        ...
        return this.tsInAmbientContext(function () {
          switch (startType) {
            case 68:
              nany.declare = true;
              return _superPropGet(TypeScriptParserMixin, "parseFunctionStatement", _this42, 3)([nany, false, false]);
            case 80:
              nany.declare = true;
              return _this42.parseClass(nany, true, false);
            case 126:
              return _this42.tsParseEnumDeclaration(nany, {
                declare: true
              });
            case 112:
            ...
            case 75:
            case 74:
              if (!_this42.match(75) || !_this42.isLookaheadContextual("enum")) {
                nany.declare = true;
                return _this42.parseVarStatement(nany, kind || _this42.state.value, true);
              }
              _this42.expect(75);
              return _this42.tsParseEnumDeclaration(nany, {
                "const": true,
            ...
            case 129:
              {
                var result = _this42.tsParseInterfaceDeclaration(nany, {
                  declare: true
                });
            ...
            default:
              if (tokenIsIdentifier(startType)) {
                return _this42.tsParseDeclaration(nany, _this42.state.value, true, null);
              }
          }
        });
      }
      ...
      value: function tsTryParseGenericAsyncArrowFunction(startLoc) {
        ...
        var res = this.tsTryParseAndCatch(function () {
          var node = _this43.startNodeAt(startLoc);
          node.typeParameters = _this43.tsParseTypeParameters(_this43.tsParseConstModifier);
          _superPropGet(TypeScriptParserMixin, "parseFunctionParams", _this43, 3)([node]);
          node.returnType = _this43.tsTryParseTypeOrTypePredicateAnnotation();
          _this43.expect(19);
          return node;
        });
        this.state.maybeInArrowParameters = oldMaybeInArrowParameters;
        if (!res) return;
        return _superPropGet(TypeScriptParserMixin, "parseArrowExpression", this, 3)([res, null, true]);
      }
    }, {
      ...
      value: function tsParseTypeArguments() {
        ...
        node.params = this.tsInType(function () {
          return _this44.tsInTopLevelContext(function () {
            _this44.expect(47);
      ...
      value: function isExportDefaultSpecifier() {
        ...
        return _superPropGet(TypeScriptParserMixin, "isExportDefaultSpecifier", this, 3)([]);
      }
    }, {
      key: "parseBindingElement",
      value: function parseBindingElement(flags, decorators) {
      ...
      value: function isSimpleParameter(node) {
        return node.type === "TSParameterProperty" && _superPropGet(TypeScriptParserMixin, "isSimpleParameter", this, 3)([node.parameter]) || _superPropGet(TypeScriptParserMixin, "isSimpleParameter", this, 3)([node]);
      }
    }, {
      ...
      value: function setArrowFunctionParameters(node, params, trailingCommaLoc) {
        _superPropGet(TypeScriptParserMixin, "setArrowFunctionParameters", this, 3)([node, params, trailingCommaLoc]);
      ...
      value: function parseFunctionBodyAndFinish(node, type) {
        ...
        if (bodilessType === "TSDeclareFunction" && this.state.isAmbientContext) {
          ...
          if (node.declare) {
            return _superPropGet(TypeScriptParserMixin, "parseFunctionBodyAndFinish", this, 3)([node, bodilessType, isMethod]);
          }
        }
        this.tsDisallowOptionalPattern(node);
        return _superPropGet(TypeScriptParserMixin, "parseFunctionBodyAndFinish", this, 3)([node, type, isMethod]);
      }
    }, {
      ...
      value: function registerFunctionStatementId(node) {
        if (!node.body && node.id) {
          ...
          _superPropGet(TypeScriptParserMixin, "registerFunctionStatementId", this, 3)([node]);
        }
      }
    }, {
      ...
      value: function tsCheckForInvalidTypeCasts(items) {
        ...
        items.forEach(function (node) {
          if ((node == null ? void 0 : node.type) === "TSTypeCastExpression") {
            _this45.raise(TSErrors.UnexpectedTypeAnnotation, node.typeAnnotation);
          }
        });
      }
    }, {
      ...
      key: "parseArrayLike",
      value: function parseArrayLike(close, canBePattern, isTuple, refExpressionErrors) {
        var node = _superPropGet(TypeScriptParserMixin, "parseArrayLike", this, 3)([close, canBePattern, isTuple, refExpressionErrors]);
      ...
      value: function parseSubscript(base, startLoc, noCalls, state) {
        ...
        if (this.match(47) || this.match(51)) {
          ...
          var result = this.tsTryParseAndCatch(function () {
            if (!noCalls && _this46.atPossibleAsyncArrow(base)) {
              var asyncArrowFn = _this46.tsTryParseGenericAsyncArrowFunction(startLoc);
              if (asyncArrowFn) {
                return asyncArrowFn;
              }
            }
            var typeArguments = _this46.tsParseTypeArgumentsInExpression();
            if (!typeArguments) return;
            if (isOptionalCall && !_this46.match(10)) {
              missingParenErrorLoc = _this46.state.curPosition();
              return;
            }
            if (tokenIsTemplate(_this46.state.type)) {
              var _result = _superPropGet(TypeScriptParserMixin, "parseTaggedTemplateExpression", _this46, 3)([base, startLoc, state]);
              {
                _result.typeParameters = typeArguments;
              }
              return _result;
            }
            if (!noCalls && _this46.eat(10)) {
              var _node12 = _this46.startNodeAt(startLoc);
              _node12.callee = base;
              _node12.arguments = _this46.parseCallExpressionArguments(11);
              _this46.tsCheckForInvalidTypeCasts(_node12.arguments);
              {
                _node12.typeParameters = typeArguments;
              }
              if (state.optionalChainMember) {
                _node12.optional = isOptionalCall;
              }
              return _this46.finishCallExpression(_node12, state.optionalChainMember);
            }
            var tokenType = _this46.state.type;
            if (tokenType === 48 || tokenType === 52 || tokenType !== 10 && tokenCanStartExpression(tokenType) && !_this46.hasPrecedingLineBreak()) {
              return;
            }
            var node = _this46.startNodeAt(startLoc);
            node.expression = base;
            {
              node.typeParameters = typeArguments;
            }
            return _this46.finishNode(node, "TSInstantiationExpression");
          });
        ...
        return _superPropGet(TypeScriptParserMixin, "parseSubscript", this, 3)([base, startLoc, noCalls, state]);
      }
    }, {
      key: "parseNewCallee",
      value: function parseNewCallee(node) {
        var _callee$extra;
        _superPropGet(TypeScriptParserMixin, "parseNewCallee", this, 3)([node]);
      ...
      value: function parseExprOp(left, leftStartLoc, minPrec) {
        ...
        if (tokenOperatorPrecedence(58) > minPrec && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (isSatisfies = this.isContextual(120)))) {
          ...
          node.typeAnnotation = this.tsInType(function () {
            ...
            if (_this47.match(75)) {
              if (isSatisfies) {
                _this47.raise(Errors.UnexpectedKeyword, _this47.state.startLoc, {
                  keyword: "const"
                });
              }
              return _this47.tsParseTypeReference();
            }
            return _this47.tsParseType();
          });
          this.finishNode(node, isSatisfies ? "TSSatisfiesExpression" : "TSAsExpression");
          this.reScan_lt_gt();
          return this.parseExprOp(node, leftStartLoc, minPrec);
        }
        return _superPropGet(TypeScriptParserMixin, "parseExprOp", this, 3)([left, leftStartLoc, minPrec]);
      }
    }, {
      key: "checkReservedWord",
      value: function checkReservedWord(word, startLoc, checkKeywords, isBinding) {
        if (!this.state.isAmbientContext) {
          _superPropGet(TypeScriptParserMixin, "checkReservedWord", this, 3)([word, startLoc, checkKeywords, isBinding]);
        }
      }
    }, {
      key: "checkImportReflection",
      value: function checkImportReflection(node) {
        _superPropGet(TypeScriptParserMixin, "checkImportReflection", this, 3)([node]);
        if (node.module && node.importKind !== "value") {
      ...
      key: "isPotentialImportPhase",
      value: function isPotentialImportPhase(isExport) {
        if (_superPropGet(TypeScriptParserMixin, "isPotentialImportPhase", this, 3)([isExport])) return true;
        if (this.isContextual(130)) {
          var ch = this.lookaheadCharCode();
      ...
      key: "applyImportPhase",
      value: function applyImportPhase(node, isExport, phase, loc) {
        _superPropGet(TypeScriptParserMixin, "applyImportPhase", this, 3)([node, isExport, phase, loc]);
        if (isExport) {
      ...
      value: function parseImport(node) {
        if (this.match(134)) {
          ...
          return _superPropGet(TypeScriptParserMixin, "parseImport", this, 3)([node]);
        }
        var importNode;
        if (tokenIsIdentifier(this.state.type) && this.lookaheadCharCode() === 61) {
          ...
          if (this.lookaheadCharCode() === 61) {
            ...
            importNode = _superPropGet(TypeScriptParserMixin, "parseImportSpecifiersAndAfter", this, 3)([node, maybeDefaultIdentifier]);
          }
        } else {
          importNode = _superPropGet(TypeScriptParserMixin, "parseImport", this, 3)([node]);
        }
      ...
      value: function parseExport(node, decorators) {
        if (this.match(83)) {
          ...
          var assign = node;
          assign.expression = _superPropGet(TypeScriptParserMixin, "parseExpression", this, 3)([]);
          this.semicolon();
          this.sawUnambiguousESM = true;
          ...
          return _superPropGet(TypeScriptParserMixin, "parseExport", this, 3)([node, decorators]);
        }
      }
    }, {
      key: "isAbstractClass",
      ...
      value: function parseExportDefaultExpression() {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseExportDefaultExpression", this, 3)([]);
      }
    }, {
      ...
      value: function parseVarStatement(node, kind) {
        ...
        var declaration = _superPropGet(TypeScriptParserMixin, "parseVarStatement", this, 3)([node, kind, allowMissingInitializer || isAmbientContext]);
      ...
      value: function parseStatementContent(flags, decorators) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseStatementContent", this, 3)([flags, decorators]);
      }
    }, {
      ...
      value: function parseClassMember(classBody, member, state) {
        ...
        var callParseClassMemberWithIsStatic = function callParseClassMemberWithIsStatic() {
          if (_this48.tsIsStartOfStaticBlocks()) {
            _this48.next();
            _this48.next();
            if (_this48.tsHasSomeModifiers(member, modifiers)) {
              _this48.raise(TSErrors.StaticBlockCannotHaveModifier, _this48.state.curPosition());
            }
            _superPropGet(TypeScriptParserMixin, "parseClassStaticBlock", _this48, 3)([classBody, member]);
          } else {
            _this48.parseClassMemberWithIsStatic(classBody, member, state, !!member["static"]);
          }
        };
        if (member.declare) {
      ...
      value: function parseClassMemberWithIsStatic(classBody, member, state, isStatic) {
        ...
        _superPropGet(TypeScriptParserMixin, "parseClassMemberWithIsStatic", this, 3)([classBody, member, state, isStatic]);
      }
    }, {
      ...
      value: function parseExpressionStatement(node, expr, decorators) {
        ...
        return decl || _superPropGet(TypeScriptParserMixin, "parseExpressionStatement", this, 3)([node, expr, decorators]);
      }
    }, {
      key: "shouldParseExportDeclaration",
      value: function shouldParseExportDeclaration() {
        if (this.tsIsDeclarationStart()) return true;
        return _superPropGet(TypeScriptParserMixin, "shouldParseExportDeclaration", this, 3)([]);
      }
    }, {
      key: "parseConditional",
      value: function parseConditional(expr, startLoc, refExpressionErrors) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseConditional", this, 3)([expr, startLoc, refExpressionErrors]);
      }
    }, {
      key: "parseParenItem",
      value: function parseParenItem(node, startLoc) {
        var newNode = _superPropGet(TypeScriptParserMixin, "parseParenItem", this, 3)([node, startLoc]);
        if (this.eat(17)) {
          newNode.optional = true;
          this.resetEndLocation(node);
        }
      ...
      value: function parseExportDeclaration(node) {
        ...
        var declaration = isIdentifier && this.tsTryParseExportDeclaration() || _superPropGet(TypeScriptParserMixin, "parseExportDeclaration", this, 3)([node]);
      ...
      value: function parseClassId(node, isStatement, optionalId, bindingType) {
        ...
        _superPropGet(TypeScriptParserMixin, "parseClassId", this, 3)([node, isStatement, optionalId, node.declare ? 1024 : 8331]);
      ...
      value: function parseClassProperty(node) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseClassProperty", this, 3)([node]);
      }
    }, {
      key: "parseClassPrivateProperty",
      value: function parseClassPrivateProperty(node) {
        ...
        this.parseClassPropertyAnnotation(node);
        return _superPropGet(TypeScriptParserMixin, "parseClassPrivateProperty", this, 3)([node]);
      }
    }, {
      key: "parseClassAccessorProperty",
      value: function parseClassAccessorProperty(node) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseClassAccessorProperty", this, 3)([node]);
      }
    }, {
      key: "pushClassMethod",
      value: function pushClassMethod(classBody, method, isGenerator, isAsync, isConstructor, allowsDirectSuper) {
        ...
        _superPropGet(TypeScriptParserMixin, "pushClassMethod", this, 3)([classBody, method, isGenerator, isAsync, isConstructor, allowsDirectSuper]);
      }
    }, {
      key: "pushClassPrivateMethod",
      value: function pushClassPrivateMethod(classBody, method, isGenerator, isAsync) {
        var typeParameters = this.tsTryParseTypeParameters(this.tsParseConstModifier);
        if (typeParameters) method.typeParameters = typeParameters;
        _superPropGet(TypeScriptParserMixin, "pushClassPrivateMethod", this, 3)([classBody, method, isGenerator, isAsync]);
      }
    }, {
      ...
      value: function declareClassPrivateMethodInScope(node, kind) {
        ...
        _superPropGet(TypeScriptParserMixin, "declareClassPrivateMethodInScope", this, 3)([node, kind]);
      }
    }, {
      key: "parseClassSuper",
      value: function parseClassSuper(node) {
        _superPropGet(TypeScriptParserMixin, "parseClassSuper", this, 3)([node]);
        if (node.superClass && (this.match(47) || this.match(51))) {
          {
      ...
      value: function parseObjPropValue(prop, startLoc, isGenerator, isAsync, isPattern, isAccessor, refExpressionErrors) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseObjPropValue", this, 3)([prop, startLoc, isGenerator, isAsync, isPattern, isAccessor, refExpressionErrors]);
      }
    }, {
      key: "parseFunctionParams",
      value: function parseFunctionParams(node, isConstructor) {
        var typeParameters = this.tsTryParseTypeParameters(this.tsParseConstModifier);
        if (typeParameters) node.typeParameters = typeParameters;
        _superPropGet(TypeScriptParserMixin, "parseFunctionParams", this, 3)([node, isConstructor]);
      }
    }, {
      key: "parseVarId",
      value: function parseVarId(decl, kind) {
        _superPropGet(TypeScriptParserMixin, "parseVarId", this, 3)([decl, kind]);
      ...
      value: function parseAsyncArrowFromCallExpression(node, call) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseAsyncArrowFromCallExpression", this, 3)([node, call]);
      }
    }, {
      key: "parseMaybeAssign",
      value: function parseMaybeAssign(refExpressionErrors, afterLeftParse) {
        ...
        if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
          state = this.state.clone();
          jsx = this.tryParse(function () {
            return _superPropGet(TypeScriptParserMixin, "parseMaybeAssign", _this50, 3)([refExpressionErrors, afterLeftParse]);
          }, state);
          if (!jsx.error) return jsx.node;
          var context = this.state.context;
          var currentContext = context[context.length - 1];
        ...
        if (!((_jsx = jsx) != null && _jsx.error) && !this.match(47)) {
          return _superPropGet(TypeScriptParserMixin, "parseMaybeAssign", this, 3)([refExpressionErrors, afterLeftParse]);
        }
        ...
        var arrow = this.tryParse(function (abort) {
          ...
          var expr = _superPropGet(TypeScriptParserMixin, "parseMaybeAssign", _this50, 3)([refExpressionErrors, afterLeftParse]);
      ...
      value: function parseMaybeUnary(refExpressionErrors, sawUnary) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseMaybeUnary", this, 3)([refExpressionErrors, sawUnary]);
      }
    }, {
      key: "parseArrow",
      value: function parseArrow(node) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseArrow", this, 3)([node]);
      }
    }, {
      key: "parseFunctionParamType",
      value: function parseFunctionParamType(param) {
      ...
      value: function isAssignable(node, isBinding) {
        switch (node.type) {
          ...
          case "TSParameterProperty":
            return true;
          default:
            return _superPropGet(TypeScriptParserMixin, "isAssignable", this, 3)([node, isBinding]);
        }
      }
    }, {
      key: "toAssignable",
      value: function toAssignable(node) {
        ...
        switch (node.type) {
          ...
          default:
            _superPropGet(TypeScriptParserMixin, "toAssignable", this, 3)([node, isLHS]);
        }
      }
    }, {
      ...
      value: function checkToRestConversion(node, allowPattern) {
        switch (node.type) {
          ...
          case "TSNonNullExpression":
            ...
            break;
          default:
            _superPropGet(TypeScriptParserMixin, "checkToRestConversion", this, 3)([node, allowPattern]);
        }
      }
    }, {
      key: "isValidLVal",
      value: function isValidLVal(type, isUnparenthesizedInAssign, binding) {
        switch (type) {
          ...
          default:
            return _superPropGet(TypeScriptParserMixin, "isValidLVal", this, 3)([type, isUnparenthesizedInAssign, binding]);
        }
      }
    }, {
      key: "parseBindingAtom",
      value: function parseBindingAtom() {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseBindingAtom", this, 3)([]);
      }
    }, {
      ...
      value: function parseMaybeDecoratorArguments(expr, startLoc) {
        if (this.match(47) || this.match(51)) {
          ...
          if (this.match(10)) {
            var call = _superPropGet(TypeScriptParserMixin, "parseMaybeDecoratorArguments", this, 3)([expr, startLoc]);
            {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseMaybeDecoratorArguments", this, 3)([expr, startLoc]);
      }
    }, {
      key: "checkCommaAfterRest",
      value: function checkCommaAfterRest(close) {
        ...
        return _superPropGet(TypeScriptParserMixin, "checkCommaAfterRest", this, 3)([close]);
      }
    }, {
      key: "isClassMethod",
      value: function isClassMethod() {
        return this.match(47) || _superPropGet(TypeScriptParserMixin, "isClassMethod", this, 3)([]);
      }
    }, {
      key: "isClassProperty",
      value: function isClassProperty() {
        return this.match(35) || this.match(14) || _superPropGet(TypeScriptParserMixin, "isClassProperty", this, 3)([]);
      }
    }, {
      key: "parseMaybeDefault",
      value: function parseMaybeDefault(startLoc, left) {
        var node = _superPropGet(TypeScriptParserMixin, "parseMaybeDefault", this, 3)([startLoc, left]);
        if (node.type === "AssignmentPattern" && node.typeAnnotation && node.right.start < node.typeAnnotation.start) {
      ...
      value: function getTokenFromCode(code) {
        ...
        _superPropGet(TypeScriptParserMixin, "getTokenFromCode", this, 3)([code]);
      }
    }, {
      key: "reScan_lt_gt",
      value: function reScan_lt_gt() {
      ...
      value: function toAssignableListItem(exprList, index, isLHS) {
        ...
        _superPropGet(TypeScriptParserMixin, "toAssignableListItem", this, 3)([exprList, index, isLHS]);
      }
    }, {
      key: "typeCastToParameter",
      value: function typeCastToParameter(node) {
      ...
      value: function shouldParseArrow(params) {
        ...
        return _superPropGet(TypeScriptParserMixin, "shouldParseArrow", this, 3)([params]);
      }
    }, {
      key: "shouldParseAsyncArrow",
      value: function shouldParseAsyncArrow() {
        return this.match(14) || _superPropGet(TypeScriptParserMixin, "shouldParseAsyncArrow", this, 3)([]);
      }
    }, {
      key: "canHaveLeadingDecorator",
      value: function canHaveLeadingDecorator() {
        return _superPropGet(TypeScriptParserMixin, "canHaveLeadingDecorator", this, 3)([]) || this.isAbstractClass();
      }
    }, {
      key: "jsxParseOpeningElementAfterName",
      value: function jsxParseOpeningElementAfterName(node) {
        ...
        return _superPropGet(TypeScriptParserMixin, "jsxParseOpeningElementAfterName", this, 3)([node]);
      }
    }, {
      key: "getGetterSetterExpectedParamCount",
      value: function getGetterSetterExpectedParamCount(method) {
        var baseCount = _superPropGet(TypeScriptParserMixin, "getGetterSetterExpectedParamCount", this, 3)([method]);
        var params = this.getObjectOrClassMethodParams(method);
      ...
      value: function parseCatchClauseParam() {
        var param = _superPropGet(TypeScriptParserMixin, "parseCatchClauseParam", this, 3)([]);
        var type = this.tsTryParseTypeAnnotation();
        if (type) {
      ...
      value: function parseClass(node, isStatement, optionalId) {
        ...
        try {
          return _superPropGet(TypeScriptParserMixin, "parseClass", this, 3)([node, isStatement, optionalId]);
        } finally {
      ...
      value: function parseMethod(node, isGenerator, isAsync, isConstructor, allowDirectSuper, type, inClassScope) {
        var method = _superPropGet(TypeScriptParserMixin, "parseMethod", this, 3)([node, isGenerator, isAsync, isConstructor, allowDirectSuper, type, inClassScope]);
        if (method["abstract"]) {
      ...
      value: function parse() {
        ...
        return _superPropGet(TypeScriptParserMixin, "parse", this, 3)([]);
      }
    }, {
      key: "getExpression",
      value: function getExpression() {
        ...
        return _superPropGet(TypeScriptParserMixin, "getExpression", this, 3)([]);
      }
    }, {
      ...
      value: function parseExportSpecifier(node, isString, isInTypeExport, isMaybeTypeOnly) {
        ...
        node.exportKind = "value";
        return _superPropGet(TypeScriptParserMixin, "parseExportSpecifier", this, 3)([node, isString, isInTypeExport, isMaybeTypeOnly]);
      }
    }, {
      key: "parseImportSpecifier",
      value: function parseImportSpecifier(specifier, importedIsString, isInTypeOnlyImport, isMaybeTypeOnly, bindingType) {
        ...
        return _superPropGet(TypeScriptParserMixin, "parseImportSpecifier", this, 3)([specifier, importedIsString, isInTypeOnlyImport, isMaybeTypeOnly, isInTypeOnlyImport ? 4098 : 4096]);
      }
    }, {
    ...
    return _createClass(PlaceholdersParserMixin, [{
      ...
      value: function parsePlaceholder(expectedNode) {
        if (this.match(133)) {
          ...
          this.next();
          this.assertNoSpace();
          node.name = _superPropGet(PlaceholdersParserMixin, "parseIdentifier", this, 3)([true]);
          this.assertNoSpace();
          this.expect(133);
      ...
      value: function getTokenFromCode(code) {
        if (code === 37 && this.input.charCodeAt(this.state.pos + 1) === 37) {
          ...
          _superPropGet(PlaceholdersParserMixin, "getTokenFromCode", this, 3)([code]);
        }
      }
    }, {
      key: "parseExprAtom",
      value: function parseExprAtom(refExpressionErrors) {
        return this.parsePlaceholder("Expression") || _superPropGet(PlaceholdersParserMixin, "parseExprAtom", this, 3)([refExpressionErrors]);
      }
    }, {
      key: "parseIdentifier",
      value: function parseIdentifier(liberal) {
        return this.parsePlaceholder("Identifier") || _superPropGet(PlaceholdersParserMixin, "parseIdentifier", this, 3)([liberal]);
      }
    }, {
      key: "checkReservedWord",
      value: function checkReservedWord(word, startLoc, checkKeywords, isBinding) {
        if (word !== undefined) {
          _superPropGet(PlaceholdersParserMixin, "checkReservedWord", this, 3)([word, startLoc, checkKeywords, isBinding]);
        }
      }
    }, {
      key: "parseBindingAtom",
      value: function parseBindingAtom() {
        return this.parsePlaceholder("Pattern") || _superPropGet(PlaceholdersParserMixin, "parseBindingAtom", this, 3)([]);
      }
    }, {
      key: "isValidLVal",
      value: function isValidLVal(type, isParenthesized, binding) {
      ...
      value: function toAssignable(node, isLHS) {
        if (node && node.type === "Placeholder" && node.expectedNode === "Expression") {
          ...
          _superPropGet(PlaceholdersParserMixin, "toAssignable", this, 3)([node, isLHS]);
        }
      }
    }, {
      key: "chStartsBindingIdentifier",
      value: function chStartsBindingIdentifier(ch, pos) {
        if (_superPropGet(PlaceholdersParserMixin, "chStartsBindingIdentifier", this, 3)([ch, pos])) {
          return true;
        }
        var nextToken = this.lookahead();
      ...
      value: function verifyBreakContinue(node, isBreak) {
        ...
        _superPropGet(PlaceholdersParserMixin, "verifyBreakContinue", this, 3)([node, isBreak]);
      }
    }, {
      key: "parseExpressionStatement",
      value: function parseExpressionStatement(node, expr) {
        ...
        if (expr.type !== "Placeholder" || (_expr$extra = expr.extra) != null && _expr$extra.parenthesized) {
          return _superPropGet(PlaceholdersParserMixin, "parseExpressionStatement", this, 3)([node, expr]);
        }
        if (this.match(14)) {
          var stmt = node;
          stmt.label = this.finishPlaceholder(expr, "Identifier");
          this.next();
          stmt.body = _superPropGet(PlaceholdersParserMixin, "parseStatementOrSloppyAnnexBFunctionDeclaration", this, 3)([]);
      ...
      value: function parseBlock(allowDirectives, createNewLexicalScope, afterBlockParse) {
        return this.parsePlaceholder("BlockStatement") || _superPropGet(PlaceholdersParserMixin, "parseBlock", this, 3)([allowDirectives, createNewLexicalScope, afterBlockParse]);
      }
    }, {
      key: "parseFunctionId",
      value: function parseFunctionId(requireId) {
        return this.parsePlaceholder("Identifier") || _superPropGet(PlaceholdersParserMixin, "parseFunctionId", this, 3)([requireId]);
      }
    }, {
      key: "parseClass",
      value: function parseClass(node, isStatement, optionalId) {
        ...
        _superPropGet(PlaceholdersParserMixin, "parseClassSuper", this, 3)([node]);
        node.body = this.parsePlaceholder("ClassBody") || _superPropGet(PlaceholdersParserMixin, "parseClassBody", this, 3)([!!node.superClass, oldStrict]);
        return this.finishNode(node, type);
      }
    }, {
      key: "parseExport",
      value: function parseExport(node, decorators) {
        var placeholder = this.parsePlaceholder("Identifier");
        if (!placeholder) return _superPropGet(PlaceholdersParserMixin, "parseExport", this, 3)([node, decorators]);
        var node2 = node;
        ...
        return _superPropGet(PlaceholdersParserMixin, "parseExport", this, 3)([node2, decorators]);
      }
    }, {
      key: "isExportDefaultSpecifier",
      value: function isExportDefaultSpecifier() {
        ...
        return _superPropGet(PlaceholdersParserMixin, "isExportDefaultSpecifier", this, 3)([]);
      }
    }, {
      ...
      value: function maybeParseExportDefaultSpecifier(node, maybeDefaultIdentifier) {
        ...
        return _superPropGet(PlaceholdersParserMixin, "maybeParseExportDefaultSpecifier", this, 3)([node, maybeDefaultIdentifier]);
      }
    }, {
      key: "checkExport",
      value: function checkExport(node) {
        ...
        _superPropGet(PlaceholdersParserMixin, "checkExport", this, 3)([node]);
      ...
      value: function parseImport(node) {
        var placeholder = this.parsePlaceholder("Identifier");
        if (!placeholder) return _superPropGet(PlaceholdersParserMixin, "parseImport", this, 3)([node]);
        node.specifiers = [];
        if (!this.isContextual(98) && !this.match(12)) {
      ...
      value: function parseImportSource() {
        return this.parsePlaceholder("StringLiteral") || _superPropGet(PlaceholdersParserMixin, "parseImportSource", this, 3)([]);
      }
    }, {
      key: "assertNoSpace",
...
var v8intrinsic = function v8intrinsic(superClass) {
  return /*#__PURE__*/function (_superClass6) {
    ...
    return _createClass(V8IntrinsicMixin, [{
      ...
      key: "parseExprAtom",
      value: function parseExprAtom(refExpressionErrors) {
        return this.parseV8Intrinsic() || _superPropGet(V8IntrinsicMixin, "parseExprAtom", this, 3)([refExpressionErrors]);
      }
    }]);
  }(superClass);
};
...
var ExpressionParser = /*#__PURE__*/function (_LValParser) {
  ...
  return _createClass(ExpressionParser, [{
    key: "checkProto",
    value: function checkProto(prop, isRecord, sawProto, refExpressionErrors) {
    ...
    value: function setOptionalParametersError(refExpressionErrors) {
    ...
    value: function parseMaybeAssign(refExpressionErrors, afterLeftParse) {
      ...
      if (isYield) {
        ...
        var _startsExpr = this.hasPlugin("v8intrinsic") ? tokenCanStartExpression(_type) : tokenCanStartExpression(_type) && !this.match(54);
        if (_startsExpr && !this.isAmbiguousPrefixOrIdentifier()) {
    ...
    value: function parseMaybeUnary(refExpressionErrors, sawUnary) {
      ...
      if (isAwait) {
        var type = this.state.type;
        var _startsExpr2 = this.hasPlugin("v8intrinsic") ? tokenCanStartExpression(type) : tokenCanStartExpression(type) && !this.match(54);
        if (_startsExpr2 && !this.isAmbiguousPrefixOrIdentifier()) {
    ...
    value: function parseUpdate(node, update, refExpressionErrors) {
      ...
      while (tokenIsPostfix(this.state.type) && !this.canInsertSemicolon()) {
        ...
        _node13.operator = this.state.value;
        _node13.prefix = false;
        _node13.argument = expr;
        this.next();
        this.checkLVal(expr, expr = this.finishNode(_node13, "UpdateExpression"));
      }
      return expr;
    }
  }, {
    ...
    key: "isAmbiguousPrefixOrIdentifier",
    value: function isAmbiguousPrefixOrIdentifier() {
    ...
    key: "parseYield",
    value: function parseYield(startLoc) {
      var node = this.startNodeAt(startLoc);
  ...
  return _createClass(StatementParser, [{
    ...
    value: function maybeTakeDecorators(maybeDecorators, classNode, exportNode) {
      if (maybeDecorators) {
        ...
        if ((_classNode$decorators = classNode.decorators) != null && _classNode$decorators.length) {
          ...
          (_classNode$decorators2 = classNode.decorators).unshift.apply(_classNode$decorators2, _toConsumableArray(maybeDecorators));
        } else {
    ...
    value: function parseDecorator() {
      ...
      if (this.hasPlugin("decorators")) {
        ...
        if (this.match(10)) {
          ...
          while (this.eat(16)) {
            var _node14 = this.startNodeAt(startLoc);
            _node14.object = expr;
            if (this.match(139)) {
              this.classScope.usePrivateName(this.state.value, this.state.startLoc);
              _node14.property = this.parsePrivateName();
            } else {
    ...
    value: function parseExport(node, decorators) {
      ...
      if (this.eat(65)) {
        ...
        _node15.declaration = decl;
        if (decl.type === "ClassDeclaration") {
          this.maybeTakeDecorators(decorators, decl, _node15);
        } else if (decorators) {
          throw this.raise(Errors.UnsupportedDecoratorExport, node);
        }
        this.checkExport(_node15, true, true);
        this.sawUnambiguousESM = true;
        return this.finishNode(_node15, "ExportDefaultDeclaration");
      }
      this.unexpected(null, 5);
    }
  }, {
    ...
    value: function parseExportDeclaration(node) {
      if (this.match(80)) {
        var _node16 = this.parseClass(this.startNode(), true, false);
        return _node16;
      }
...
var Parser = /*#__PURE__*/function (_StatementParser) {
  function Parser(options, input, pluginsMap) {
    ...
    _this67.startIndex = options.startIndex;
    var optionFlags = 0;
    ...
    _this67.optionFlags = optionFlags;
    return _this67;
  }
...
function getParser(options, input) {
  ...
  if (options != null && options.plugins) {
    var _iterator18 = _createForOfIteratorHelper(options.plugins),
      _step18;
    try {
...
function getParserClass(pluginsMap) {
  var pluginList = [];
  var _iterator19 = _createForOfIteratorHelper(mixinPluginNames),
    _step19;
  try {
  ...
  if (!cls) {
    cls = Parser;
    var _iterator20 = _createForOfIteratorHelper(pluginList),
      _step20;
    try {
