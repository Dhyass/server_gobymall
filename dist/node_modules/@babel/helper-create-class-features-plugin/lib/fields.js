      ...
      if (prop.isPrivate()) {
        ...
        if (!update) {
          ...
          if (!privateFieldsAsSymbolsOrProperties && newHelpers(file) && isMethod && !isStatic) {
            ...
            classBrandId != null ? classBrandId : classBrandId = prop.scope.generateUidIdentifier("".concat(className, "_brand"));
            id = classBrandId;
          } else {
...
function privateNameVisitorFactory(visitor) {
  var nestedVisitor = _traverse.visitors.environmentVisitor(Object.assign({}, visitor));
...
function transformPrivateNamesUsage(ref, path, privateNamesMap, _ref3, state) {
  var privateFieldsAsProperties = _ref3.privateFieldsAsProperties,
    noUninitializedPrivateFieldAccess = _ref3.noUninitializedPrivateFieldAccess,
    noDocumentAll = _ref3.noDocumentAll,
    innerBinding = _ref3.innerBinding;
...
function buildFieldsInitNodes(ref, superRef, props, privateNamesMap, file, setPublicClassFields, privateFieldsAsSymbolsOrProperties, noUninitializedPrivateFieldAccess, constantSuper, innerBindingRef) {
  ...
  var classRefForInnerBinding = ref != null ? ref : props[0].scope.generateUidIdentifier((innerBindingRef == null ? void 0 : innerBindingRef.name) || "Class");
