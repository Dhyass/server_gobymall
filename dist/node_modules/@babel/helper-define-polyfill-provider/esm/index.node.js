...
function resolve$1(path) {
  var resolved = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new Set();
      ...
      if (newIndex === Infinity) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var _path = data.path,
              index = data.index;
            if (isPathStillValid(_path)) {
              if (newIndex < index) {
                var _path$insertBefore = _path.insertBefore(node),
...
var _require = (0, _module.createRequire)(import /*::(_)*/.meta.url); // eslint-disable-line
...
function resolve(dirname, moduleName, absoluteImports) {
  ...
  if (typeof absoluteImports === "string") {
    basedir = _path2["default"].resolve(basedir, absoluteImports);
  }
  try {
