...
function _fsReaddirRecursive() {
  var data = require("fs-readdir-recursive");
...
function readdir(dirname, includeDotfiles, filter) {
  {
    return _fsReaddirRecursive()("", function (filename, index, currentDirectory) {
      var stat = _fs().statSync(_path().join(currentDirectory, filename));
...
function _compile() {
  _compile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(filename, opts) {
    var result;
...
function withExtension(filename) {
  ...
  var newBasename = _path().basename(filename, _path().extname(filename)) + ext;
