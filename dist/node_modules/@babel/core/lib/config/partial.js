...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(loadPrivatePartialConfig),
  _marked2 = /*#__PURE__*/_regeneratorRuntime().mark(loadPartialConfig);
...
function resolveRootMode(rootDir, rootMode) {
  switch (rootMode) {
    ...
    case "upward-optional":
      {
        var upwardRootDir = (0, _index.findConfigUpwards)(rootDir);
        return upwardRootDir === null ? rootDir : upwardRootDir;
      }
    case "upward":
      {
        var _upwardRootDir = (0, _index.findConfigUpwards)(rootDir);
        if (_upwardRootDir !== null) return _upwardRootDir;
        throw Object.assign(new Error("Babel was run with rootMode:\"upward\" but a root could not " + "be found when searching upward from \"".concat(rootDir, "\".\n") + "One of the following config files must be in the directory tree: " + "\"".concat(_index.ROOT_CONFIG_FILENAMES.join(", "), "\".")), {
  ...
  return _regeneratorRuntime().wrap(function loadPrivatePartialConfig$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 2:
        ...
        return _context.delegateYield((0, _index.resolveShowConfigPath)(absoluteCwd), "t0", 8);
      case 8:
...
function loadPartialConfig(opts) {
  ...
  return _regeneratorRuntime().wrap(function loadPartialConfig$(_context2) {
