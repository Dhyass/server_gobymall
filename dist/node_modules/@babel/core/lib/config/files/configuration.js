...
function readConfigCode(filepath, data) {
  ...
  return _regeneratorRuntime().wrap(function readConfigCode$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 2:
        _context2.t0 = (0, _moduleTypes["default"]);
        _context2.t1 = filepath;
        return _context2.delegateYield((0, _async.isAsync)(), "t2", 5);
      case 5:
        if (!_context2.t2) {
          _context2.next = 9;
          break;
        ...
        break;
      case 9:
        _context2.t3 = "require";
      case 10:
        _context2.t4 = _context2.t3;
        _context2.t5 = "You appear to be using a native ECMAScript module configuration " + "file, which is only supported when running Babel asynchronously " + "or when using the Node.js `--experimental-require-module` flag.";
        _context2.t6 = "You appear to be using a configuration file that contains top-level " + "await, which is only supported when running Babel asynchronously.";
        return _context2.delegateYield((0, _context2.t0)(_context2.t1, _context2.t4, _context2.t5, _context2.t6), "t7", 14);
      case 14:
        options = _context2.t7;
        cacheNeedsConfiguration = false;
        if (!(typeof options === "function")) {
          _context2.next = 21;
          break;
        }
        return _context2.delegateYield(runConfig(options, data), "t8", 18);
      case 18:
        _yield$runConfig = _context2.t8;
