  ...
  return _regeneratorRuntime().wrap(function loadPlugin$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 4:
        ...
        _resolvePlugin = (0, _context.t0)(_context.t1, _context.t2, _context.t4);
        filepath = _resolvePlugin.filepath;
        loader = _resolvePlugin.loader;
        return _context.delegateYield(requireModule("plugin", loader, filepath), "t5", 9);
      case 9:
        value = _context.t5;
  ...
  return _regeneratorRuntime().wrap(function loadPreset$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 4:
        ...
        _resolvePreset = (0, _context2.t0)(_context2.t1, _context2.t2, _context2.t4);
        filepath = _resolvePreset.filepath;
        loader = _resolvePreset.loader;
        return _context2.delegateYield(requireModule("preset", loader, filepath), "t5", 9);
      case 9:
        value = _context2.t5;
  ...
  return _regeneratorRuntime().wrap(function requireModule$(_context4) {
    while (1) switch (_context4.prev = _context4.next) {
      ...
      case 6:
        ...
        return _context4.delegateYield((0, _moduleTypes["default"])(name, loader, "You appear to be using a native ECMAScript module ".concat(type, ", ") + "which is only supported when running Babel asynchronously " + "or when using the Node.js `--experimental-require-module` flag.", "You appear to be using a ".concat(type, " that contains top-level await, ") + "which is only supported when running Babel asynchronously.", true), "t2", 9);
      case 9:
